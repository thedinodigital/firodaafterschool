...
REVOKE ALL ON FUNCTION public.fas_delete_child(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.fas_delete_child(uuid) FROM anon;
GRANT EXECUTE ON FUNCTION public.fas_delete_child(uuid) TO authenticated;